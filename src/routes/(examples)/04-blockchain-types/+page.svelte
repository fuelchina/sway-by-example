<script lang="ts">
  ...
  import hexContent from './out/release/blockchain-types.hex?raw';
  import abiContent from './out/release/blockchain-types-abi.json?raw';
  import storageSlotsContent from './out/release/blockchain-types-storage_slots.json?raw';
