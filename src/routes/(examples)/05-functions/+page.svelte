<script lang="ts">
  ...
  import hexContent from './out/release/functions.hex?raw';
  import abiContent from './out/release/functions-abi.json?raw';
  import storageSlotsContent from './out/release/functions-storage_slots.json?raw';
