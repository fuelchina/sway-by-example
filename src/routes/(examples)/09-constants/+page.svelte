<script lang="ts">
  ...
  import hexContent from './out/release/constants.hex?raw';
  import abiContent from './out/release/constants-abi.json?raw';
  import storageSlotsContent from './out/release/constants-storage_slots.json?raw';
