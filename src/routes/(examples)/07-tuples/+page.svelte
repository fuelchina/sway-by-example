<script lang="ts">
  ...
  import hexContent from './out/release/tuples.hex?raw';
  import abiContent from './out/release/tuples-abi.json?raw';
  import storageSlotsContent from './out/release/tuples-storage_slots.json?raw';
