<script lang="ts">
  ...
  import hexContent from './out/release/enums.hex?raw';
  import abiContent from './out/release/enums-abi.json?raw';
  import storageSlotsContent from './out/release/enums-storage_slots.json?raw';
