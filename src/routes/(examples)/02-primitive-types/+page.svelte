<script lang="ts">
  ...
  import hexContent from './out/release/primitive-types.hex?raw';
  import abiContent from './out/release/primitive-types-abi.json?raw';
  import storageSlotsContent from './out/release/primitive-types-storage_slots.json?raw';
